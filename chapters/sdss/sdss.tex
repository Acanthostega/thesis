...
\begin{figure}[hp]
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}{Parameters of a normal distribution for photometric
            redshifts versus spectroscopic redshifts in the
    ...
    \begin{minipage}{\linewidth}
        ...
        selection with a Monte Carlo process. Results seem to converge on a
    value of 2.1993 steradians (roughly $7220°^2$).\label{fig:sdss_area}}
    \end{minipage}
\end{figure}
