...
Fortunately, recently~\cite{Tempel+14} in their FoF analysis of galaxy groups
...
computation. We show in \bartreffigure{bell_comparison} the stellar mass
...
\begin{figure}[htb]
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \captionof{figure}{The distribution of stellar masses
...
accurate.\label{fig:bell_comparison}}
    ...
    \begin{minipage}{0.49\linewidth}
        ...
        \captionof{figure}{The distribution of stellar masses in solar units
            ...
            default estimation. There is no high mass galaxies, but some
            stellar masses are still with bad low values. We keep them to avoid
        introducing supplementary incompleteness in the galaxy
