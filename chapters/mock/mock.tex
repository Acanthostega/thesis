...
We have seen in \bartrefchapter{sdss} that spectroscoped galaxies are just
...
\begin{figure}[htb]
    ...
    regions, no need to correct for missing galaxies. All galaxies above the
given threshold magnitude are visible.\label{fig:subsamples}}
    \end{minipage}
    \begin{minipage}{0.49\linewidth}
...
close to edges (see \bartrefchapter{friends_of_friends_algorithm} for a
