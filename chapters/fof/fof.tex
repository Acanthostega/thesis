...
\bartrefequation{zfromvp} for $v_{\rm p}^{\rm LOS}$, replacing $z_{\cos}$ by
...
by the transformations of the simulation box (see \bartrefsection{mockzspace}).
...
\begin{figure*}
    ...
    \caption{Same as \bartreffigure{test_true_small}, but
...
\begin{figure*}
    ...
    \caption{Same as \bartreffigure{test_true_small}, but for the distant
...
\begin{figure*}
    ...
    \caption{Same as \bartreffigure{test_true_big}, but where the different
