...
density profile from \citet{NFW+97} (see \bartrefappendix{profiles}) with a
...
\remark{%
    ...
    density fraction of matter in the Universe (\citet{Planck+13} cosmology)
    ...
    used to defined a halo relatively to the background.
}
