...
\newcommand{\titlebackground}[2]{%
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \end{scope}
        \begin{scope}
            \draw[opacity=0.7,very thick,yellow!35!black,fill=#1]
...
\newcommand{\background}[3]{%
    \begin{tikzpicture}[overlay,remember picture]
        \begin{scope}
            ...
            \pgfmathdeclarerandomlist{fonts}{{\bf}{\tt}{\rm}{\sf}}
            \foreach \a in {1,...,#1}{%
                ...
                \node[color=red!\d!yellow, opacity=\opacity,distort] at ($ (current page.center) +
